...
const AllTask = () => {
  ...
  return (
    <div className="bg-[#1c1c1c] p-5 rounded mt-5 overflow-x-auto w-full">
      ...
      <div className="">
        {authData.empdata.map((elem, idx) => {
          return (
            <div
              key={idx}
              className="border-2 border-emerald-500 mb-2 py-2 px-4 flex justify-between rounded min-w-[600px] "
            >
